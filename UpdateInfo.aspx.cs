...
public partial class _Default : Page
{
    ...
    {
        bool InGroup = false;
        PrincipalContext pc = new PrincipalContext(ContextType.Domain, "omni.phish", userName: "sa-shippingrequest", password: "7ho$pf$sPlnxng");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            var PermGroupCheck = CheckIsInGroup(permissionGroup, User);//variable to call func to check if user is in perm group
