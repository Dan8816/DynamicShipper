...
public partial class ShippingRequest : Page
{
    ...
    public string UserSamName = WindowsIdentity.GetCurrent().Name;//this get the current users full logged in name e.g. oai\dengle
 ...
 //>===========================================> Dan Engle 10/8/2018 >=============================================================>
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        string SamName = WindowsIdentity.GetCurrent().Name.Substring(5);//will need to change substr to 4 in prod//get the param to us as samaccount add Dan Engle 10/10/2018
